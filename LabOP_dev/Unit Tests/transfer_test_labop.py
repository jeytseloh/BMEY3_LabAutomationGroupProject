...
protocol = labop.Protocol('transfer_unit_test_labop_v0')
protocol.name = "Transfer Unit Test Using LabOP v0"
protocol.description = "This protocol is a unit test designed to validate accuracy in transferring 10ul, written in LabOP"
doc.add(protocol)
...
# well_plate = protocol.primitive_step('EmptyContainer',
...
source_well = protocol.primitive_step('PlateCoordinates',
                                      ...
                                      coordinates='A1')
destination_well_single = protocol.primitive_step('PlateCoordinates',
                                                  source=plate.output_pin('samples'),
                                                  coordinates='A2')
destination_well_column = protocol.primitive_step('PlateCoordinates',
                                                  source=plate.output_pin('samples'),
                                                  coordinates='A2:H2')
...
transfer = protocol.primitive_step('Transfer',
                                   ...
                                   destination=destination_well_single.output_pin('samples'),
