...
def run(protocol: protocol_api.ProtocolContext):
    ...
    thermocycler_module.set_block_temperature(temperature=37.0, hold_time_minutes=1.0)
    # 15. Incubate at 60 degrees for 5 minutes
    thermocycler_module.close_lid()
    thermocycler_module.set_lid_temperature(temperature=70.0)
    thermocycler_module.set_block_temperature(temperature=60.0, hold_time_minutes=1.0)
from opentrons import protocol_api
