...
def run(protocol: protocol_api.ProtocolContext):
    ...
    tc_mod.set_block_temperature(temperature=37, hold_time_minutes=60, block_max_volume=40) 
    # 15. Incubate at 60 degrees for 5 minutes
    tc_mod.set_lid_temperature(temperature=70)#10 degrees higher than inside
    tc_mod.set_block_temperature(temperature=60, hold_time_minutes=5, block_max_volume=40) 
